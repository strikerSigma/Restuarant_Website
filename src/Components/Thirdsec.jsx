...
const Thirdsec = () => {
  return (
    <div className='thirdSection'>
      ...
      <div className='w-60 ml-40'><img src='/Pic1.png'/></div>
      ...
      <div className='w-60 ml-40 md:mt-10 IV1 md:hidden'><img src='/Pic2.png'/></div>
      ...
      <div className='w-60 ml-40 md:mt-10 IV2 '><img src='/Pic2.png'/></div>

      <div className='w-60 ml-40 md:mt-10'><img src='/Pic3.png'/></div>
      <div className='pt-20 px-20 md:mt-10'>
      ...
      <div className='form md:flex mt-20'>
        ...
        <div className='px-10 maps'><img src='/Maps.png'/></div>
      </div>
      <div className='cards md:flex'>
        <div className='m-20'><img src='/Card1.png'/></div>
        <div className='m-20'><img src='/Card2.png'/></div>
      </div>
    </div>
  )
}
